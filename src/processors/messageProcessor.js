...
// --- CORREGIDO: Cambiado el nombre de la función importada a 'handleRegisteredCustomer' (nombre correcto para V1) ---
...
const processMessage = async (from, messageText) => {
  ...
  try {
    ...
    if (customer && customer.service_status === 'activo') {
      ...
      // --- CORREGIDO: Llamar a la función correcta 'handleRegisteredCustomer' (nombre correcto para V1) ---
