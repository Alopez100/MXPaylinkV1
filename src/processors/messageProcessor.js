...
// --- CORREGIDO: Cambiado el nombre de la función importada a 'handlePaymentRequest' (nombre correcto con el que se exporta en registeredHandler.js) ---
...
const processMessage = async (from, messageText) => {
  ...
  try {
    ...
    if (customer && customer.service_status === 'activo') {
      ...
      // --- CORREGIDO: Llamar a la función correcta 'handlePaymentRequest' (nombre correcto con el que se exporta en registeredHandler.js) ---
